...
$resAni = mysqli_query($conn, "SELECT * FROM animal ");
...
<nav class="nav nav-pills flex-column flex-sm-row">
    <a class="flex-sm-fill text-sm-center text-light nav-link active" href="admin.php">Home</a>
    <a class="flex-sm-fill text-sm-center text-light nav-link" href="create.php">Create New Entrys</a>
