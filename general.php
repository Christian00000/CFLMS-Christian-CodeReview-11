...
$resAni = mysqli_query($conn,"SELECT * FROM animal WHERE  category='large' OR  category='small' ");
...
background-size: cover; ">
    ...
    <span class="badge badge-primary text-wrap text-center mb-5" style='width:15rem;  font-size:2rem;' >Hallo <?php echo $userRow['userName' ]; ?></span>
		<nav class="nav nav-pills flex-column flex-sm-row">
			...
			<a class="flex-sm-fill text-sm-center text-light nav-link active" href="general.php">Small and Big Animals</a>
			<a class="flex-sm-fill text-sm-center text-light nav-link" href="senior.php">Senior Animals</a>
